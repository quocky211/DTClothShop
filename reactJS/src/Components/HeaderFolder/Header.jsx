  ...
  return (
    <Navbar bg="light" expand="lg" fixed="top">
      <Container fluid>
        ...
        <input type="checkbox" name="" className="search-input" id="search-input" />
        ...
        <div className="nav-mobile">
          ...
          <ul className="nav-mobile-list">
            ...
            <ul className="type-mobile-product">
              {
                FakeData[2].map((item) => (<ListTypeProductMobile matype={item.matype} name={item.name} />))
              }
            </ul>
            <hr />
        ...
        <Nav.Link className="lovelists" href={loveList}> Sản phẩm yêu thích </Nav.Link>
